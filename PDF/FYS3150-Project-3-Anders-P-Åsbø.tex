...
\begin{document}
\title{Numerical integration}   % self-explanatory
\author{Anders P. Åsbø}               % self-explanatory

%\newdate{date}{30}{09}{2019} - \displaydate{date}
\date{\today}
...
All code for this report was written in Python 3.6, and the complete set of program files can be found at \url{https://github.com/FunkMarvel/CompPhys-Project-3}.
